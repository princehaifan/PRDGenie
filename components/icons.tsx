...
export const GenieIcon: React.FC<IconProps> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={className}>
    <path d="M11.96 2.016c-.23 0-.45.09-.61.25l-5.03 5.03a.87.87 0 00-.25.61v8.19c0 .23.09.45.25.61l5.03 5.03c.16.16.38.25.61.25s.45-.09.61-.25l5.03-5.03a.87.87 0 00.25-.61V7.906a.87.87 0 00-.25-.61l-5.03-5.03a.87.87 0 00-.61-.25zm3.56 6.81l-1.42 1.42-3.56-3.56 1.42-1.42 3.56 3.56zm-7.12 0l3.56 3.56-1.42 1.42-3.56-3.56 1.42-1.42z" />
  </svg>
);
...
export const MarkdownIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
        <path d="M10.29 8.35L12.12 10.18L13.95 8.35" />
        <path d="M12.12 15.82V10.18" />
...
export const WordIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
        <path d="M4 18h16" />
        <path d="M14 11.5c0 .8-.7 1.5-1.5 1.5h-1c-.8 0-1.5-.7-1.5-1.5v-1c0-.8.7-1.5 1.5-1.5h1c.8 0 1.5.7 1.5 1.5" />
        <path d="M14 4.5v7" />
        <path d="M18 4.5v7" />
        <path d="M4 4.5h16v12a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2z" />
    </svg>
);
